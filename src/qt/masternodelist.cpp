...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, CMasternode *pmn)
{
    ...
    QTableWidgetItem *protocolItem = new QTableWidgetItem(QString::number(pmn ? MIN_PEER_PROTO_VERSION : -1));
    QTableWidgetItem *statusItem = new QTableWidgetItem(QString::fromStdString(pmn ? pmn->Status() : "MISSING"));
    QTableWidgetItem *activeSecondsItem = new QTableWidgetItem(QString::fromStdString(DurationToDHMS(pmn ? (pmn->lastTimeSeen - pmn->sigTime) : 0)));
    QTableWidgetItem *lastSeenItem = new QTableWidgetItem(QString::fromStdString(DateTimeStrFormat("%Y-%m-%d %H:%M", pmn ? pmn->lastTimeSeen + QDateTime::currentDateTime().offsetFromUtc() : 0)));
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(pmn ? CIonAddress(address2.ToString()).ToString() : ""));
...
void MasternodeList::updateNodeList()
{
    ...
    BOOST_FOREACH(CMasternode& mn, vMasternodes)
    {
        ...
        QTableWidgetItem *protocolItem = new QTableWidgetItem(QString::number(mn.protocolVersion)); // TODO: Incorrect - change to nProtocolVersion
        ...
        QTableWidgetItem *lastSeenItem = new QTableWidgetItem(QString::fromStdString(DateTimeStrFormat("%Y-%m-%d %H:%M", mn.lastTimeSeen + QDateTime::currentDateTime().offsetFromUtc())));
