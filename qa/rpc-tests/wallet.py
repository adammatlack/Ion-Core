...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 DSLK, node2 has none. 
#   d) node0 sends 21 DARKSILK to node2, in two transactions (11 DARKSILK, then 10 DSLK).
...
from test_framework import DarkSilkTestFramework
from util import *
...
class WalletTest (DarkSilkTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 DARKSILK from 0 to 2 using sendtoaddress call.
